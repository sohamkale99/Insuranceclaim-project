        ...
        <Card style={{ maxWidth: 600, margin: "0 auto" }}>
          <CardContent>
            ...
            <Typography variant="subtitle1" color="textSecondary" >
              Fill all the mandatory fields to claim policy
          </Typography>
            <form>
              ...
              <Typography variant="body2" align="left" gutterBottom>Crop Details : </Typography>
              <Grid container spacing={1}>
                {
                  inputFormElements.slice(9, 13).map(input => <Grid xs={input.xs} sm={input.sm} item>
                    <TextField {...input} />
                  </Grid>)
                }
              </Grid>
