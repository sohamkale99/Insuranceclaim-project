export const inputFormElements=[
    ...
    {
        name:"crop type",placeholder:"Enter crop name", label:"Crop Type", 
        variant:"outlined", fullWidth:true,required:true, xs:12,sm:6
    },
    {
        name:"land area",placeholder:"Land in acres", label:"Land details", 
        variant:"outlined", fullWidth:true,required:true, xs:12,sm:6
    },
    {
        name:"Reason",placeholder:"Reason for claim", label:"Policy Reason", 
        variant:"outlined", fullWidth:true,required:true, xs:12,sm:6
    },
]